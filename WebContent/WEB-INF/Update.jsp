        ...
        <div class="sideBar" align="center" style=" float: left;">
         ...
         <div class="content">   
			...
			<form method = "POST" action = "Update">
				  ...
				  <input type = "text" name="userID" placeholder="New User ID"><br/> 
				  ...
				  <input type = "text" name="platform" placeholder="New platform" ><br/>
				  <input type = "text" name="userName" placeholder="New user name" ><br/>
