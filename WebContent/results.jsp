...
<head>
	...
	<%
		...
		String SearchGame = new String();
		SearchGame = (String) request.getAttribute("SearchGame").toString();
		
		IGameServices iGameService = new GameServicesImpl();
		ArrayList<Game> gameList = new ArrayList<Game>();
		gameList = iGameService.searchGame(SearchGame);
				
    %>

<title>Search - <%= SearchGame %> | EXBO</title>
...
<body>
	...
	<div class="mainArea" style="min-height: auto; margin-bottom: 0px; margin-top: 120px; padding: 1px;">
		<h2><%= gameList.size() %> results found matching <font color="red"><%= SearchGame %></font></h2>
	</div>
	...
	<div class="mainArea">
		...
		<h2 style="color: dimgray;">
			To find the service you need, you can quickly contact our Customer
			Support Team. <br /> We are glad to help you out.
		</h2>

		<a href="ContactInfo"><button class="contact">Contact Now</button></a>
		<br><br><br>
