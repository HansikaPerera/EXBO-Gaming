...
<head>
	...
	<%
		...
		IGameServices ob1 = new GameServicesImpl();
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	<title> Play Games | EXBO Gaming </title>
...
<body>
    ...
    <div class="mainArea" style="margin-bottom: 0px; margin-top: 50px; padding: 1px;">
      <div class = "topic" >
      ...
      Playing : <%= ob1.loadGameName(GameID) %> 
        ...
        <div class="sideBar">
			...
			<img src = "images/game5.jpg" width = "260" height = "270" align = "center">
			<br/><br/>
			<img src = "images/finallogoo.png" width = "260" height = "270" align = "center">
        </div>
