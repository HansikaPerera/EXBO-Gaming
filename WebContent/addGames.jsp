...
<title>ADD GAME | EXBO Gaming</title>
	...
	<div class="mainArea" align="center">
		...
		<div class="content">
			...
			<form method="POST" action="AddGame">
				...
				<input type="text" name="gameName" placeholder="ADD Game Name" required /><br> <font color="#3090C7"> Select The Category of the Game:<br /></font> 
				...
				<input type="radio" name="category" value="Adventure" required />Adventure &nbsp; 
